...
- [ ] Deployment records and store them in memory
- [ ] Add 2 more peers from the service as Docker containers
- [ ] Make the peers know each other
- [ ] Send the deployment record from client to service
- [ ] Serialize the deployment record into a binary format

...
| ---------------- | ---------------------------------------------------------- |
| Action           | I will store the key pair in Windows-Keychain/DPAPI.       |
...
- [ ] Load the key pair from Windows-Keychain/DPAPI
  ...
  - [ ] Implement the _from_keypair method to load the keypair from the keyring and set the private key, public key, and address properties accordingly for Solana addresses.
